...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFDpneTe+GG6pDaET+NTa/++f4m4RUeMxfZ2V36yLQA==
::YB416Ek+ZG8=
::
::
...
@ ECHO.
@ ECHO               /!\ USE "LOCATE THE GAME" in Origin after usage, DONT NEED TO REDOWNLOAD THE ENTIRE GAME /!\
@ ECHO.
...
@ ECHO.
@ ECHO.
echo                 System cleaned successfully, please RESTART your computer
@ ECHO.
echo   USE "LOCATE THE GAME" in Origin after use, NO NEED TO RE-DOWNLOAD THE ENTIRE GAME
@ ECHO.
@ ECHO.
echo. & pause
